# SplatsDB Rust Port — Full Specification

## Goal
Complete the Rust port of splatsdb from Python. Fix all bugs, optimize with rayon/BLAS, and port missing modules.

## Location
- Rust project: `C:\Users\Brian\Desktop\splatsdb`
- Python source (reference): `C:\Users\Brian\Desktop\splatsdb-main\src\splatsdb\`
...
Port `C:\Users\Brian\Desktop\splatsdb-main\src\splatsdb\splats.py` to Rust as `src/splats.rs`.
